...
rod1  = Rod(mass=1, inertia=np.eye(3), length=LENGTH, state=RodState(r=np.array([0, 0, 0]), q=Rotation.from_euler("xyz", [0, -85, 0], degrees=True)))
rod2  = Rod(mass=1, inertia=np.eye(3), length=LENGTH, state=RodState(r=np.array([0, 0, 0]), q=Rotation.from_euler("xyz", [0, -85, 120], degrees=True)))
rod3  = Rod(mass=1, inertia=np.eye(3), length=LENGTH, state=RodState(r=np.array([0, 0, 0]), q=Rotation.from_euler("xyz", [0, -85, 240], degrees=True)))
